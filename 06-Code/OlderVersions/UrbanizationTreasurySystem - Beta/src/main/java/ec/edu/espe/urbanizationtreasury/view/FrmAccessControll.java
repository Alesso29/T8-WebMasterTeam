 ...
 */
public class FrmAccessControll extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Access Controll");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmAccessControll.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmAccessControll().setVisible(true);
            }
        });
    }
